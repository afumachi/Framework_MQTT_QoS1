...
arquivo_aplicacao = "medidas_luminosidade.txt"

# ===== Parâmetros de rede / camadas =====
ID_sensor      = 1
ID_gateway     = 0
Tempo_entre_pacotes = 2   # segundos (colocado no byte 4 do DL)
ESPERA_UL_s    = 2        # segundos de espera pelo pacote UL após envio do DL
...
try:
    while True:
        ...
        for arq in [arquivo_gerencia, arquivo_aplicacao]:
        ...
        for j in range(1, medidas + 1):
            ...
            try:
                ...
                # Imprime o erro no console para você saber o que falhou (ajuda nos testes!)
            ...
            Contador_Pacote_DL = (Contador_Pacote_DL + 1) 
            Pacote_DL[12] = int(Contador_Pacote_DL / 256)
            Pacote_DL[13] = int(Contador_Pacote_DL % 256)
            ...
            if Pacote_UL_novo:
                ...
                with open(arquivo_aplicacao, 'a+') as f:
