...
//
//
//  Última Modificação: Branquinho / Felipe / Luís Felipe / Anderson - 10/07/2026
//
...
const char* TOPIC_DL      = "mot_lora_mqtt_FUMACHI/gateway/downlink";  // Python → ESP32
const char* TOPIC_UL      = "mot_lora_mqtt_FUMACHI/gateway/uplink";    // ESP32  → Python
